...
local function paint(p)
	...
	hi("MuvimSearch", fg, bg_alt)
	hi("MuvimSearchBorder", dim, bg)
	-- Markdown. Treesitter @markup.* falls back to these when the bundled
	-- parser is older than the queries (Neovim 0.11 in the containers).
	hi("markdownH1", blue, nil, "bold")
	hi("markdownH2", blue, nil, "bold")
	hi("markdownH3", cyan, nil, "bold")
	hi("markdownH4", cyan, nil, "bold")
	hi("markdownH5", purple, nil, "bold")
	hi("markdownH6", purple, nil, "bold")
	hi("markdownHeadingDelimiter", dim)
	hi("markdownBold", fg, nil, "bold")
	hi("markdownItalic", fg, nil, "italic")
	hi("markdownBoldItalic", fg, nil, "bold")
	hi("markdownCode", green)
	hi("markdownCodeBlock", green)
	hi("markdownUrl", blue, nil, "underline")
	hi("markdownLinkText", cyan)
	hi("markdownListMarker", yellow)
	hi("markdownBlockquote", dim, nil, "italic")
	hi("markdownRule", dim)
	hi("Question", green)
	hi("MoreMsg", green)
	...
	hi("NvimTreeGitRenamed", purple)
	hi("NvimTreeGitMerge", orange)
	hi("NvimTreeGitIgnored", dim)
	-- Sign letter and filename share one color per git state.
	hi("NvimTreeGitDirtyIcon", yellow)
	hi("NvimTreeGitNewIcon", green)
	hi("NvimTreeGitDeletedIcon", red)
	hi("NvimTreeGitStagedIcon", green)
	hi("NvimTreeGitRenamedIcon", purple)
	hi("NvimTreeGitMergeIcon", orange)
	hi("NvimTreeGitIgnoredIcon", dim)
	hi("NvimTreeGitFileDirtyHL", yellow)
	hi("NvimTreeGitFileNewHL", green)
	hi("NvimTreeGitFileDeletedHL", red)
	hi("NvimTreeGitFileStagedHL", green)
	hi("NvimTreeGitFileRenamedHL", purple)
	hi("NvimTreeGitFileMergeHL", orange)
	hi("NvimTreeGitFileIgnoredHL", dim)
	hi("NvimTreeGitFolderDirtyHL", yellow)
	hi("NvimTreeGitFolderNewHL", green)
	hi("NvimTreeGitFolderDeletedHL", red)
	hi("NvimTreeGitFolderStagedHL", green)
	hi("NvimTreeGitFolderRenamedHL", purple)
	hi("NvimTreeGitFolderMergeHL", orange)
	hi("NvimTreeGitFolderIgnoredHL", dim)
	hi("AlphaHeader", blue)
	hi("AlphaButtons", fg)
